                ...
                <div class="card-header" style="border-bottom: 0;">
                    <div class="row">
                        ...
                        <div class="col text-right">
                            <a href="#" class="btn btn-sm btn-success btn-icon" data-toggle="modal" data-target="#rekapModal">
                                <span class="oi oi-clipboard" aria-hidden="true"></span>
                            </a>
                            <a href="#" class="btn btn-sm btn-primary btn-icon" id="reload">
                                <span class="oi oi-reload" aria-hidden="true"></span>
                            </a>
                            <a href="<?= base_url('rekap/add') ?>" class="btn btn-sm btn-primary btn-icon">
...
<!-- Modal -->
<div class="modal fade" id="detailRekapModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
...
<div class="modal fade" id="rekapModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-md">
            <div class="modal-header">
