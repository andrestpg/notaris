                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="nama_dan_no" name="nama_dan_no">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="no_berkas" class="col-md-2 col-form-label form-label">No. Berkas</label>
                            <div class="col-md-5">
                                <input type="number" class="form-control" id="no_berkas" name="no_berkas">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tgl" class="col-md-2 col-form-label form-label">Tanggal</label>
                            <div class="col-md-5">
                                <input type="date" class="form-control mb-2" id="tgl" name="tgl" value="<?= date('Y-m-d') ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="ploting" name="ploting">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="bphtb" name="bphtb">
                            </div>
                        </div>
                        <div class="form-group row">
