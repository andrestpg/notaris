                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="date" class="form-control mb-2" id="tgl_masuk" name="tgl_masuk" value="<?= date('Y-m-d') ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tgl_keluar" class="col-sm-2 col-form-label form-label">Tanggal Keluar</label>
                            <div class="col-sm-5">
                                <input type="date" class="form-control mb-2" id="tgl_keluar" name="tgl_keluar" value="<?= date('Y-m-d') ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="data_sertifikat" name="data_sertifikat">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <textarea class="form-control" id="nb" name="nb" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-5">
