            ...
            <?php $pbval = array_column($pb, 'pemberi');?>
            <?php $pnval = array_column($pn, 'penerima');?>
                ...
                <div class="card-body">
                    <form action="" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="nama" class="col-sm-3 col-form-label form-label">Pihak Pemberi</label>
                                            <div class="col-sm-9">
                                                <select name="pemberi[]" multiple class="form-control" id="first-option" required >
                                                    <?php foreach($klien as $row): ?>
                                                        <?php $selected = array_search($row['id'], $pbval);?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="nama" class="col-sm-3 col-form-label form-label">Pihak Penerima</label>
                                            <div class="col-sm-9">
                                                <select name="penerima[]" multiple class="form-control" id="second-option" required >
                                                    <?php foreach($klien as $row): ?>
                                                        <?php $selected = array_search($row['id'], $pnval);?>
                                                        <?php if($selected !== FALSE): ?>
                                                            <option value="<?= $row['id'] ?>" selected ><?= $row['nama'] ?></option>
                                                            <?php else: ?>
                                                            <option value="<?= $row['id'] ?>"><?= $row['nama'] ?></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="no_akta" name="no_akta" value="<?= $ppat['no_akta'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="date" class="form-control mb-2" id="tgl_akta" name="tgl_akta" value="<?= date('Y-m-d', strtotime($ppat['tgl_akta'])) ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="hukum" name="hukum" value="<?= $ppat['hukum'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="jenis_hak" name="jenis_hak" value="<?= $ppat['jenis_hak'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="letak" name="letak" value="<?= $ppat['letak'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="number" class="form-control" id="luas_tanah" name="luas_tanah" value="<?= $ppat['luas_tanah'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="number" class="form-control" id="luas_bangunan" name="luas_bangunan" value="<?= $ppat['luas_bangunan'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="number" class="form-control" id="harga" name="harga" value="<?= $ppat['harga'] ?>">
                                ...
                                <div class="card mb-3 rounded">
                                    ...
                                    <div class="card-body px-2 pb-2">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control" id="nop_tahun" name="nop_tahun" value="<?= $ppat['nop_tahun'] ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="number" class="form-control" id="njop" name="njop" value="<?= $ppat['njop'] ?>">
                                ...
                                <div class="card mb-3 rounded">
                                    ...
                                    <div class="card-body px-2 pb-2">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="number" class="form-control" id="jml_ssb" name="jml_ssb" value="<?= $ppat['jml_ssb'] ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="date" class="form-control" id="tgl_ssb" name="tgl_ssb" value="<?= date('Y-m-d', strtotime($ppat['tgl_ssb'])) ?>">
                                ...
                                <div class="card mb-3 rounded">
                                    ...
                                    <div class="card-body px-2 pb-2">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="number" class="form-control" id="jml_ssp" name="jml_ssp" value="<?= $ppat['jml_ssp'] ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="date" class="form-control" id="tgl_ssp" name="tgl_ssp" value="<?= date('Y-m-d', strtotime($ppat['tgl_ssp'])) ?>">
