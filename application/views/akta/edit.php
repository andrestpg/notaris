                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="no_berkas" name="no_berkas" value="<?= $akta['no_berkas'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="date" class="form-control mb-2" id="tgl_akta" name="tgl_akta" value="<?= date('Y-m-d',strtotime($akta['tgl_akta'])) ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="sifat_akta" name="sifat_akta" value="<?= $akta['sifat_akta'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <textarea class="form-control" id="keterangan" name="keterangan" rows="3"><?= $akta['keterangan'] ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-5">
