            ...
            <div class="card mb-grid">
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <img src="<?= base_url('assets/img/').$admin['foto'] ?>" style="width: 200px; height: 200px; border-radius: 50%;">
                        <div class="form-group">
                          <label class="form-label" for="foto">Foto</label>
                          <input type="file" class="form-control-file" name="foto" id="foto" placeholder="Pilih Foto">
                        </div>
                        ...
                        <?php if($this->uri->segment(2) != 'edit_profil'): ?>
                        <fieldset class="form-group">
                            ...
                            <div class="col-md-5">
                                ...
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="akses" id="akses1" value="0" <?php if($user['akses'] == 0){echo 'checked';} ?>>
                                    Admin
                                </label>
                                </div>
                                <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="akses" id="akses2" value="1" <?php if($user['akses'] == 1){echo 'checked';} ?>>
                                    Superadmin
                                </label>
                                </div>
                            </div>
